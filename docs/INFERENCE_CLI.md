...
python inference_cli.py tts \
    ...
    --model_name "UniFlow-Audio-v1.1-XLarge" \
...
```
Here available singers are from [M4Singer](https://m4singer.github.io/), which can be found in [spk_set.json](https://huggingface.co/wsntxxn/UniFlow-Audio-v1.1-XLarge/blob/main/svs/spk_set.json).
