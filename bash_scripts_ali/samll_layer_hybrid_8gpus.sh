# nohup bash bash_scripts_ali/train_flow_matching_base_dummy_all_8gpus.sh > logs/train_flow_matching_base_dummy_all_8gpus.log 2>&1  &
...
CONTENT_FUSION=HybridContent # [DoubleContent,DummyContent,HybridContent,CrossAttention]
GPUS=8gpus
