# nohup bash bash_scripts_ali/train_flow_matching_base_hybrid_all_8gpus.sh > logs/train_flow_matching_base_hybrid_all_8gpus.log 2>&1  &
...
TORCH_NCCL_TRACE_BUFFER_SIZE=67108864 NCCL_DEBUG=INFO  NCCL_ASYNC_ERROR_HANDLING=1  accelerate launch --config_file configs_ali/accelerate/nvidia/8gpus.yaml train.py \
    ...
    model=flow_matching_base_hybrid \
    ...
    exp_dir=experiments/flow_matching_base/flow_matching_base_hybrid_all_8gpus \