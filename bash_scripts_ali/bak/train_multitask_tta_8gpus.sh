# nohup bash bash_scripts_ali/train_multitask_tta_8gpus.sh > logs/train_multitask_tta_8gpus.log 2>&1  &
...
accelerate launch --config_file configs/accelerate/8gpus.yaml train.py \
    ...
    trainer.wandb_config.name=train_multitask_tta_8gpus \
    exp_dir=experiments/tts_tta/audiocaps \
