# bash ./bash_scripts/infer_singing.sh > logs/infer_singing.log 2>&1
CUDA_VISIBLE_DEVICES=0 accelerate launch --config_file configs/accelerate/1gpu.yaml inference.py \
    # epoch_length=1000 \
    # epochs=100 \
    ...
    exp_dir=experiments/waveform_vae_audioudit_layers_24_dim_1024_diffusion/opencpop \
    # optimizer.lr=5e-5 \
