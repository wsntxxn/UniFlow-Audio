...
import sys
sys.path.append("./evaluation/GMELab")
...
if __name__ == '__main__':
    image_bind_score = calculate_imagebind_score(
        Path("/hpc_stor03/sjtu_home/yaoyun.zhang/project/x_to_audio_generation/evaluation/fad-test/samples/gen-video-5.12s-25fps-16000hz"),
        "cuda"
    )
