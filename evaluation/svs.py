# Usage: python svs.py \
#   --ref_dir /path/to/reference/audio.jsonl \
#   --gen_dir /path/to/generated/audio.jsonl \
#   --out_dir /path/to/output/directory/result.txt \
#   --c 16
...
def evaluate(args):
    ...
    with open(args.output_file, "w") as writer:
        for metric, values in results.items():
            if metric == "semitone":
                print_msg = f"{metric}: {np.mean(list(values.values())):.2%}"
            else:
