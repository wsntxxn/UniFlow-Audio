accelerate launch --config_file configs/accelerate/nvidia/8gpus.yaml train.py \
    ...
    exp_name=small_dummy_layer_fusion_resume_200k \
    exp_dir=experiments/all_visual_sound_balanced_sampling/small_dummy_layer_fusion_resume_200k \
    data@data_dict=train_val_visual_sound \
    epochs=200 \
    ++trainer.resume_from_checkpoint=experiments/all_visual_sound_balanced_sampling/small_dummy_layer_fusion_resume_200k/checkpoints/step_200000
